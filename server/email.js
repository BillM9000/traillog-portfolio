  ...
  await t.sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:500px">
        ...
        <p><a href="${process.env.APP_URL || "https://app.example.com"}" style="color:#4a7a55;font-weight:bold">Open TrailLog</a></p>
      </div>
    `,
  });
}
  ...
  await t.sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:500px">
        ...
        <p><a href="${process.env.APP_URL || "https://app.example.com"}" style="display:inline-block;background:#4a7a55;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:bold">Sign Up on TrailLog</a></p>
...
function deepLink(troopId, adventureId, tab) {
  const base = process.env.APP_URL || "https://app.example.com";
  const params = [];
...
export async function sendPasswordResetEmail(toEmail, token) {
  ...
  const url = `${process.env.APP_URL || "https://app.example.com"}/?reset=${token}`;
  await t.sendMail({
    from: `"TrailLog" <${process.env.SMTP_USER}>`,
    to: toEmail,
  ...
  await t.sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:500px">
        ...
        <p><a href="${process.env.APP_URL || "https://app.example.com"}" style="display:inline-block;background:#4a7a55;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:bold">Open TrailLog</a></p>
      </div>
    `,
  });
}
...
export async function sendVerificationEmail(toEmail, token) {
  ...
  const url = `${process.env.APP_URL || "https://app.example.com"}/api/auth/verify/${token}`;
  await t.sendMail({
    from: `"TrailLog" <${process.env.SMTP_USER}>`,
    to: toEmail,
