...
app.post("/api/adventures/:adventureId/invitations", requireAuth, requireAdventureAdmin, (req, res) => {
  try {
    ...
    const inviteUrl = `${process.env.APP_URL || "https://app.example.com"}/api/invitations/${token}`;
...
<h2>9. Contact</h2>
<p>For privacy questions or data requests, email: <strong>bill.mccoy@example.com</strong></p>
</div></body></html>`);
});
...
<h2>10. Contact</h2>
<p>Questions about these terms? Email: <strong>bill.mccoy@example.com</strong></p>
</div></body></html>`);
});
