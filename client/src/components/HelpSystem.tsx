...
type CategoryFilter = "all" | "admin" | "sysadmin";

export default function HelpSystem({ onClose, user, isAdmin, isGlobalAdmin }: HelpSystemProps) {
  ...
  const catBadge = (cat: HelpSection["cat"]) => {
