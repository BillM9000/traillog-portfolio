...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { h: "Backups", t: "Automated daily backups run at 3 AM via cron (/opt/app/backup.sh). Keeps a rolling 10 backups. Golden backups are stored separately before major schema changes. Always create a golden backup before schema migrations." },
