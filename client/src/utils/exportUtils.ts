...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function applyDataStyles(ws: any, startRow: number, endRow: number, numCols: number) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function autoFitColumns(ws: any, rows: Record<string, any>[], headers: string[]) {
  headers.forEach((h, i) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function addTitleRow(ws: any, title: string, numCols: number): number {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type ConditionalFormatFn = (ws: any, headers: string[], startRow: number, endRow: number) => void;
...
export interface SheetDef {
  ...
  title?: string;
  conditionalFormat?: ConditionalFormatFn;
}
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function addSheet(wb: any, name: string, rows: Record<string, any>[], opts: { title?: string; conditionalFormat?: ConditionalFormatFn; skipFilter?: boolean } = {}) {
 ...
 */
export async function exportXLSX(sheets: SheetDef[], filename: string) {
 ...
 */
export async function exportXLSXWithSummary(summary: SummaryDef, sheets: SheetDef[], filename: string) {
  const ExcelJS = await getExcelJS();
  const wb = new ExcelJS.Workbook();
  wb.creator = "TrailLog";
  wb.created = new Date();
  ...
  if (summary.rows?.length) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    summary.rows.forEach((r: Record<string, any>, idx: number) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function gearStatusFormat(ws: any, headers: string[], startRow: number, endRow: number) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function gearMatrixFormat(ws: any, headers: string[], startRow: number, endRow: number) {
